...
export async function generateDocs(docId: string) {
  ...
  // Load the PDF into a PDFDocument objetc
...
export async function generateEmbeddingsInPineconeVectorStore(docId: string) {
  ...
  if (namespaceAlreadyExists) {
    ...
    // If the namespace does not exists, donwload the PDF from firestore via the stored Download URL & generate the embeddings and store the iun the Pinecone vector store
